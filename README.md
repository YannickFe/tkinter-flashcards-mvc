...
> repo and
> [the original article](https://nazmul-ahsan.medium.com/how-to-organize-multi-frame-tkinter-application-with-mvc-pattern-79247efbb02b)
...
Unit tests cover deck scoring and selection logic as well as CRUD operations for the Deck service.
